...
const WordTable: React.FC<WordTableProps> = ({ words, hideControls = false }) => {
    ...
    <div className="word-table">
      ...
      <div className="table-container">
        <table className="words-table">
          <thead>
            <tr>
              <th className={hideControls ? '' : `sortable ${sortKey === 'word' ? 'active' : ''}`}
                  onClick={hideControls ? undefined : () => handleSort('word')}>
                <span>Word</span>
              ...
              {!hideControls && <th>Category</th>}
              {!hideControls && <th>Impact</th>}
            </tr>
          </thead>
          <tbody>
            {filteredAndSortedWords.length === 0 ? (
              <tr>
                <td colSpan={hideControls ? 3 : 5} className="no-results">
              ...
              filteredAndSortedWords.map((word, index) => {
                ...
                const scoreColor = getScoreColor(word.average_score);
                return (
